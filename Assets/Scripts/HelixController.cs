...
public class HelixController : MonoBehaviour
{
    ...
    public void LoadStage(int stageNumber)
    {
        ...
        for (int i = 0; i < stage.levels.Count; i++)
        {
            ...
            List<GameObject> letfParts = new List<GameObject>();
            ...
            {
                GameObject randomPart = letfParts[(Random.Range(0, letfParts.Count))];

                if (!deathparts.Contains(randomPart))
                {
                    randomPart.gameObject.AddComponent<DeatPart>();
